# EyE Dual-License Agreement for Serializable Type
Copyright (c) 2025 Glurth. All rights reserved.

This copyright applies to the **Serializable Type** software package (the "Software"), including all source code, assets, and documentation.  
